           ...
           String status=request.getParameter("status");           
                try
            {
             ...
             Connection cn= DriverManager.getConnection("jdbc:derby://localhost:1527/tiffin");       
               ...
               String pr="We are sorry you had to cancel your order..<br>we will make sure to improve our services so that you donot have to cancel your next time<br>The amount paid will be refunded back to your originals ource of payement within 48 hours"; 
            
      out.write("\n");
      out.write("            <section class=\"credit-card\"> \t\t \n");
      out.write("<div class=\"container\"> \t\t \t\t\t\t\t\t\t\n");
      out.write("<div class=\"col-lg-6\"> \t\t\t\t \t\t\t\t\n");
      out.write("<form action=\"corders.jsp\" >\n");
      out.write("<div class=\"card-details\"> \t\n");
      out.write("<h1 class=\"title\">SUCCESSFULLY CANCELLED</h1> \t\t\t\t\t\n");
