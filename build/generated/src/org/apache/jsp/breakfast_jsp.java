...
public final class breakfast_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 int c=0;
      ...
      out.write("\t\t\t\t<nav>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li class=\"tm-paging-item\"><a href=\"breakfast.jsp\" class=\"tm-paging-link active\">Breakfast</a></li>\n");
      out.write("\t\t\t\t\t\t<li class=\"tm-paging-item\"><a href=\"lunch.jsp\" class=\"tm-paging-link \">Lunch</a></li>\n");
    ...
    String chef="",meal_type="breakfast", id="",price="ggg",det="";
                try
                {            
      ...
      out.write("                                                                <h4 style=\"font-family: 'Allura', cursive;font-size:40;text-transform:uppercase\" >");
      out.print(chef);
      out.write("</h4>\n");
      ...
      out.print(price);
      out.write(" </p>\n");
      out.write("                                                                <button type='button' onclick=\"window.location.href='menu.jsp?tid=");
      out.print(id);
