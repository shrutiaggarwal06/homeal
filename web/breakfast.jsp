	...
	<!-- Top box -->
		...
		<main>
			...
			<div class="tm-paging-links">
				<nav>
					<ul>
						<li class="tm-paging-item"><a href="breakfast.jsp" class="tm-paging-link active ">Breakfast</a></li>
						<li class="tm-paging-item"><a href="lunch.jsp" class="tm-paging-link ">Lunch</a></li>
...
<%                                    
    String chef="",meal_type="breakfast", id="",price="",det="";
                try
                {            
