                ...
                <a class="navbar-brand" href="index.jsp">HOMEAL</a>
                  ...
                  <div class="collapse navbar-collapse" id="navbar-supported-content">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="corders.jsp">Orders</a>
                        <div class="circle"></div>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="#0" data-no="3">Cards</a>
                        <div class="circle"></div>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="#0" data-no="4">Password</a>
                        <div class="circle"></div>
                      </li>
                      <li class="nav-item">
